...
if __name__ == '__main__':
    ...
    ## DONE: Add args for the three model parameters: input_features, hidden_dim, output_dim
    # Model Parameters
    parser.add_argument('--input_features', type=int, default=3, metavar='IN',
                        help='# of input features (default: 3)')
    parser.add_argument('--hidden_dim', type=int, default=16, metavar='HID',
                        help='# of hidden units (default: 16)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                        help='output dimension (default: 1)')
    parser.add_argument('--extra_layer', type=bool, default=False, metavar='BOOL',
                        help='add extra hidden layer (default: False)')
    parser.add_argument('--extra_dim', type=int, default=8, metavar='HID2',
                        help='# of units in extra hidden layer (default: 8)')
